...
const en = {
  ...
  'nav.group.governmentForms': 'Government Forms',
  ...
  'nav.item.governmentForms': 'Standard Government Forms',
...
const tl: Record<TranslationKey, string> = {
  ...
  'nav.group.governmentForms': 'Mga Pormularyo ng Pamahalaan',
  ...
  'nav.item.governmentForms': 'Mga Karaniwang Pormularyo ng Pamahalaan',
...
const ceb: Record<TranslationKey, string> = {
  ...
  'nav.group.governmentForms': 'Mga Porma sa Gobyerno',
  'nav.group.records': 'Mga Talaan',
  ...
  'nav.item.governmentForms': 'Standard nga mga Porma sa Gobyerno',
